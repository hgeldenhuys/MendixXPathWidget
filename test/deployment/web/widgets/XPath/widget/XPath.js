...
define([
    ...
    "dojo/store/Memory"
], function (declare, _WidgetBase, _TemplatedMixin, dom, dojoDom, dojoProp, dojoGeometry, dojoClass, dojoStyle, dojoConstruct, dojoArray, lang, dojoText, dojoHtml, dojoEvent, dojoOn, _jQuery, widgetTemplate, xConstructor, FilteringSelect, Memory) {
    "use strict";
    var $ = _jQuery.noConflict(true);
    var xPathConstructor = xConstructor();
    ...
    return declare("XPath.widget.XPath", [_WidgetBase, _TemplatedMixin], {
        ...
        update: function (obj, callback) {
            var _this = this;
            if (obj !== null) {
                console.log("json=" + obj.get(this.jsonAttribute));
                try {
                    this.xpath = xPathConstructor.getXPathClass().deserialize(obj.get(this.jsonAttribute));
                }
                catch (e) {
                    console.error(e);
                    this.xpath = new xConstructor().newXPath();
                }
                window._xpath = this.xpath;
        ...
        _updateRendering: function (callback) {
            ...
            if (this._contextObj !== null) {
                ...
                this.rootEntityNode.innerHTML = this.xpath.entityName !== '?' ? "//" + this.xpath.entityName : "Please select an entity";
                var entities_1 = {};
                xPathConstructor.getDomain().entityNames.forEach(function (entityName) {
                    entities_1[entityName] = entityName;
                });
                console.log("this.xpath.entityName=" + this.xpath.entityName);
                mxui.dom.setSelectOptions(this.rootEntitySelectNode, entities_1, this.xpath.entityName);
                dojoOn(this.rootEntitySelectNode, "change", dojo.hitch(this, function (evt) {
                    _this.xpath.setEntity(_this.rootEntitySelectNode.value);
                }));
            }
            else {
